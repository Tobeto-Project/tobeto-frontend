            ...
            <Col xs={12} md={6}>
              <Form className="border rounded-3 my-4 mb-5 p-5">
                ...
                <div className="text-center mt-3">
                  <Link to="/girisyap">Zaten bir hesabın var mı? Giriş Yap</Link>
                </div>
              </Form>
            </Col>
            <Col xs={12} md={6}>

              <Card className="mt-4 border rounded-3  " style={{padding:"8.7rem"}}>
                <Card.Body className="mt-5 mb-5">
                <div className="d-flex flex-column justify-content-center align-items-center mb-5">
                    <Image src={link2}  style={{maxWidth: "100%", minWidth: "160px", width:"350px"}} />
                  </div>

                <div className="d-flex flex-column justify-content-center align-items-center mb-5">
                <Button variant="primary" type="submit" className="btn-lg btn-info rounded-pill px-5 mb-5"
