...
export default {
  ...
  SOCIAL_MEDIA: `${API_URL}${ENDPOINTS.SOCIAL_MEDIA_ENDPOINT}`,
  SOCIAL_MEDIA_ADD: `${API_URL}${ENDPOINTS.SOCIAL_MEDIA_ADD_ENDPOINT}`,
  SOCIAL_MEDIA_DELETE: `${API_URL}${ENDPOINTS.SOCIAL_MEDIA_DELETE_ENDPOINT}`,
  SOCIAL_MEDIA_GET_LIST: `${API_URL}${ENDPOINTS.SOCIAL_MEDIA_GETLIST_ENDPOINT}`,

  USER_SOCIAL: `${API_URL}${ENDPOINTS.USER_SOCIAL_ENDPOINT}`,
  USER_SOCIAL_ADD: `${API_URL}${ENDPOINTS.USER_SOCIAL_ADD_ENDPOINT}`,
  USER_SOCIAL_DELETE: `${API_URL}${ENDPOINTS.USER_SOCIAL_DELETE_ENDPOINT}`,
  USER_SOCIAL_GET_LIST: `${API_URL}${ENDPOINTS.USER_SOCIAL_GETLIST_ENDPOINT}`,

  FOREIGN_LANGUAGE: `${API_URL}${ENDPOINTS.FOREIGN_LANGUAGE_ENDPOINT}`,
  FOREIGN_LANGUAGE_ADD: `${API_URL}${ENDPOINTS.FOREIGN_LANGUAGE_ADD_ENDPOINT}`,
  FOREIGN_LANGUAGE_DELETE: `${API_URL}${ENDPOINTS.FOREIGN_LANGUAGE_DELETE_ENDPOINT}`,
  FOREIGN_LANGUAGE_GET_LIST: `${API_URL}${ENDPOINTS.FOREIGN_LANGUAGE_GETLIST_ENDPOINT}`,

  FOREIGN_LANGUAGE_LEVEL: `${API_URL}${ENDPOINTS.FOREIGN_LANGUAGE_LEVEL_ENDPOINT}`,
  FOREIGN_LANGUAGE_LEVEL_ADD: `${API_URL}${ENDPOINTS.FOREIGN_LANGUAGE_LEVEL_ADD_ENDPOINT}`,
  FOREIGN_LANGUAGE_LEVEL_DELETE: `${API_URL}${ENDPOINTS.FOREIGN_LANGUAGE_LEVEL_DELETE_ENDPOINT}`,
  FOREIGN_LANGUAGE_LEVEL_GET_LIST: `${API_URL}${ENDPOINTS.FOREIGN_LANGUAGE_LEVEL_GETLIST_ENDPOINT}`,

  USER_LANGUAGE: `${API_URL}${ENDPOINTS.USER_LANGUAGE_ENDPOINT}`,
  USER_LANGUAGE_ADD: `${API_URL}${ENDPOINTS.USER_LANGUAGE_ADD_ENDPOINT}`,
  USER_LANGUAGE_DELETE: `${API_URL}${ENDPOINTS.USER_LANGUAGE_DELETE_ENDPOINT}`,
  USER_LANGUAGE_GET_LIST_BY_USER: `${API_URL}${ENDPOINTS.USER_LANGUAGE_GETLIST_BY_USER_ENDPOINT}`
};
