...
export default {
  ...
  CERTIFICATE: `${API_URL}${ENDPOINTS.CERTIFICATE_ENDPOINT}`, //http://localhost:60629/api/Certificates
  CERTIFICATE_ADD: `${API_URL}${ENDPOINTS.CERTIFICATE_ADD_ENDPOINT}`, //http://localhost:60629/api/Certificates/add
  CERTIFICATE_DELETE: `${API_URL}${ENDPOINTS.CERTIFICATE_DELETE_ENDPOINT}`, //http://localhost:60629/api/Certificates/delete
  CERTIFICATE_GET_LIST: `${API_URL}${ENDPOINTS.CERTIFICATE_GETLIST_ENDPOINT}`, //http://localhost:60629/api/Certificates/getList
};
